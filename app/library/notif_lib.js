                ...
                if (value.__hrx.length > 0) {
                    value.__hrx.map((el, index) => {
                        ...
                        if(value._employee_id && value._employee_id !== value._user_login){
                            ...
                            }else if(requestor == 'sup' && el.employee_id == value._user_login && (value._type == 1 || value._type == 2 || value._type == 3 
            ...
            //    return console.log(requestor);
                ...
                if(requestor){
                    ...
                    if(requestor == 'sup'){
                        ...
                        }else if(value._type == 1 || value._type == 2 || value._type == 3 || value._type == 4 || value._type == 5 || value._type == 6
                            || value._type == 7 || value._type == 8) {
                            // console.log(523)
                                end.hr_approve = 'x';
                                // end.sup_approve = 'x';
                        }else{
